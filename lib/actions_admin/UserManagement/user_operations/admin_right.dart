...
class AdminRights extends StatelessWidget {
  const AdminRights();
  final primaryColor = const Color(0xFF20B602);
...
class SimpleBtn1 extends StatelessWidget {
  ...
  const SimpleBtn1(
      {required this.text, required this.onPressed, this.invertedColors = false});
  final primaryColor = const Color(0xFF20B602);
  final accentColor = const Color(0xffffffff);
